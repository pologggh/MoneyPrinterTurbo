...
class TraceEventType(str, Enum):
    ...
    PRODUCTION_PLAN_STARTED = "PRODUCTION_PLAN_STARTED"
    ...
    ASSET_STAGE_STARTED = "ASSET_STAGE_STARTED"
    ASSET_STAGE_FAILED = "ASSET_STAGE_FAILED"
    ASSET_STAGE_COMPLETED = "ASSET_STAGE_COMPLETED"
    ASSET_STAGE_NEEDS_RECOVERY = "ASSET_STAGE_NEEDS_RECOVERY"
    ...
    # Audio Stage
    AUDIO_STAGE_STARTED = "AUDIO_STAGE_STARTED"
    AUDIO_STAGE_COMPLETED = "AUDIO_STAGE_COMPLETED"
    AUDIO_STAGE_FAILED = "AUDIO_STAGE_FAILED"
    TTS_COMPLETED = "TTS_COMPLETED"
    SUBTITLE_COMPLETED = "SUBTITLE_COMPLETED"
    BGM_PREPARED = "BGM_PREPARED"

    # Composition Stage
    COMPOSITION_STAGE_STARTED = "COMPOSITION_STAGE_STARTED"
    COMPOSITION_STAGE_COMPLETED = "COMPOSITION_STAGE_COMPLETED"
    COMPOSITION_STAGE_FAILED = "COMPOSITION_STAGE_FAILED"
    SHOT_TIMELINE_BUILT = "SHOT_TIMELINE_BUILT"
    MEDIA_RENDER_STARTED = "MEDIA_RENDER_STARTED"
    MEDIA_RENDER_COMPLETED = "MEDIA_RENDER_COMPLETED"
    COMPOSITION_VALIDATION_FAILED = "COMPOSITION_VALIDATION_FAILED"

    # Quality Review Stage
    QUALITY_REVIEW_STARTED = "QUALITY_REVIEW_STARTED"
    QUALITY_ACCEPTED = "QUALITY_ACCEPTED"
    QUALITY_REMEDIATION_REQUESTED = "QUALITY_REMEDIATION_REQUESTED"
    PARTIAL_RERUN_STARTED = "PARTIAL_RERUN_STARTED"
    PARTIAL_RERUN_COMPLETED = "PARTIAL_RERUN_COMPLETED"
    QUALITY_REVIEW_EXHAUSTED = "QUALITY_REVIEW_EXHAUSTED"

    # Delivery Stage
    DELIVERY_STAGE_STARTED = "DELIVERY_STAGE_STARTED"
    DELIVERY_STAGE_COMPLETED = "DELIVERY_STAGE_COMPLETED"
    DELIVERY_STAGE_FAILED = "DELIVERY_STAGE_FAILED"
    DELIVERY_MANIFEST_CREATED = "DELIVERY_MANIFEST_CREATED"
