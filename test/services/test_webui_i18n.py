...
ENGLISH_FALLBACK_KEYS = frozenset(
    {
        # The unified knowledge-video workflow currently ships in English and
        # Chinese. Secondary locales intentionally use the runtime English
        # fallback until reviewed translations are available.
        "Approval Details",
        "Approval Note",
        ...
        "Legacy Storyboard Notice",
        "Legacy Video Gen Notice",
        "Legacy: One-Click Generator",
        "Legacy: Storyboard Workbench",
        "Move Down",
        "Move Up",
        "Narration",
        "No Storyboards Found",
        "Replan Beat",
        "Replan Beat Dialog Title",
        "Replan Instruction",
        "Replan Instruction Placeholder",
        "Replan Success Message",
        "Save Shot Changes",
        "Scene Description",
        "Select a Shot",
        "Shot Editor",
        "Shot Saved Successfully",
        "Shots Reordered Successfully",
        "Source Draft",
        "Stale Edit Conflict",
        "Storyboard Already Approved",
        "Storyboard Approved Successfully",
        "Storyboard Shots",
